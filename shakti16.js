const contentData = {
    history: `
        <h3>History</h3>
        <p>The present temple dates back to 1459 CE and was built on a hill called Bhasmakoot Parvat. The entrance to the sanctum is very small and devotees have to crouch to enter. An ‘Akhand Deep’ is kept lit in the temple for all 24 hours.</p>
    ...
    significance: `
        <h3>Significance</h3>
        <P> Mangala Gauri Temple in Gaya (Bihar) is yet another ancient Shaktipeeth. References to this temple can be found in various Puranas such as Padma Purana, Vayu Purana and Agni Purana. Besides this temple is mentioned in other religious texts too.</P>
                    <P> Mata Sati ended Her life after the insult of Lord Shiva in Daksha Prajapati’s Yagya. Her body was cut into 51 parts by Lord Vishnu’s Sudarshan Chakra. The places where these body parts fell became Shaktipeeths.</P>
                    <P> It is believed the breast portion of Sati Mata’s body fell at this spot. Magala Gauri Mata is known as the benevolent and loving Goddess. This temple is an ‘Upa Shakti Peeth’, one of the 18 Maha Shaktipeeths.</P>
                    <p> It is a very old temple built in the 15th century. We have to climb up a small hillock to reach the temple.</p>
                        <p> The steps route is in between houses of local people. At the starting of steps route, there is the temple of Bhima (One of Five Pandavas).</p>
                       <p> We can see his knee impression here. Here Bhima did Shraddhakarma, hence called as Bhimvedi Gaya.</p>
                        <p> There are two minor shrines dedicated to Lord of lirds Parmeswar Shiva and images of Mahishasura Mardini, Durga, and Dakshina Kali.</p>
                        <p> The temple complex encompasses of temples of Maa Kali, Lord Ganesha, Lord Hanuman and Lord Shiva.</p>
                        <div style="margin-top: 20px; text-align: center;">
      <button id="listenBtn">🔊 Listen</button>
      <button id="resetBtn">🔁 Reset</button>
    </div>
    ...
    howtoreach: `
      <h3>How to Reach</h3>
      <p>📍 Location: Gaya,Bihar<br>✈️ Nearest Airports:  Gaya International Airport (8.6 KM) <br>🚉 Railway Station:  Gaya Junction  (4.8 KM) <br>🛣️ Road ways: Manpur (5.2 KM)</p>
      <div style="margin-top: 20px; text-align: center;">
      <button id="listenBtn">🔊 Listen</button>
      <button id="resetBtn">🔁 Reset</button>
    </div>
    ...
    timings: `
      ...
      <center><p>🕘 6:00 AM - 8:00 PM</p></center>
      <div style="margin-top: 20px; text-align: center;">
      <button id="listenBtn">🔊 Listen</button>
      <button id="resetBtn">🔁 Reset</button>
    </div>
    ...
    <p><b>Prasadam:</b>prasadam typically includes items such as khichdi (a dish made with rice and lentils), puri (fried bread), sabzi (vegetable curry), sweets like ladoo or peda, and sometimes fruits. These prasadams are offered to the goddess Mangla Gauri during puja rituals and then distributed to devotees as blessings.</p>
                    <P> There are lots of hotels and lodges available around the temple for different price range. One can stay in Bodh Gaya as well.  </P>
                        <P> As this is very famous tourist place in Bihar, lots of Indian and continental restaurants are available around the temple. Both South Indian, North Indian and continental foods are available.</P>
                        <div style="margin-top: 20px; text-align: center;">
      <button id="listenBtn">🔊 Listen</button>
      <button id="resetBtn">🔁 Reset</button>
    </div>
    ...
    <p style="text-align: center;">📍Gaya,Bihar</p>
    <div style="text-align: center; margin-top: 15px;">
    <button onclick="window.open('https://www.google.com/maps/d/u/0/edit?mid=1lhUd4ltZHEEDwuknF8Sm8SrpVdeNzH0&usp=sharing', '_blank')" style="background-color: #4e3ec8; color: white; border: none; padding: 10px 20px; border-radius: 6px; cursor: pointer; font-size: 16px;">🗺️ View Location on Map </button>
  </div>

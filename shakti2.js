const contentData = {
    history: `
        ...
        <p>There are various Shiva temples in Kanchi, but “Sri Kamakshi Amman Temple” is the only one with the Goddess Sanctorum. Eight Shakti Goddesses also surround the temple.</p>
    ...
    significance: `
        <h3>Significance</h3>
        <p> The Kamakshi Amman Temple is known for its religious significance, stunning architecture, and rich history. Dedicated to Goddess Kamakshi, a divine form of Goddess Parvati, the temple holds immense spiritual importance for devotees.</p>
        <p> The temple's architecture showcases the artistic brilliance of the Pallava, Chola, and Vijayanagara dynasties, who contributed to its construction and expansion over the years. </p>
        <p> Additionally, the temple is famous for its daily aarti ceremonies and various religious services, which attract pilgrims and tourists alike.</p>
        <p> The place where Sri Kamakshi resides is known as “Nabisthana Ottiyana Peetam.” Kamakshi refers to God that lives in Kanchi and Goddess Saraswati, and Lakshmi are her both eyes.</p>
        <p> Counted among one of the Shakti Peetha’s, this is the place where the Navel or Nabhi of Goddess Sati fell when Lord Vishnu’s Sudarshana Chakra touched Goddess Sati’s body.</p>
        <div style="margin-top: 20px; text-align: center;">
      <button id="listenBtn">🔊 Listen</button>
      <button id="resetBtn">🔁 Reset</button>
    </div>
    ...
    howtoreach: `
      <h3>How to Reach</h3>
      <p>📍 Location: Kanchipuram,Tamil Nadu<br>✈️ Nearest Airports: Chennai International Airport(65 KM), Vellore Airport(77 KM) <br>🚉 Railway Station:  Kanchipuram railway station(1.2 KM) <br>🛣️ Road ways: Mahabalipuram(69 KM)</p>
      <div style="margin-top: 20px; text-align: center;">
      <button id="listenBtn">🔊 Listen</button>
      <button id="resetBtn">🔁 Reset</button>
    </div>
    ...
    timings: `
      ...
      <p>🕘 Morning: 6:00 AM - 12:30 PM<br>🕓 Evening: 4:00 PM - 8:30 PM</p>
      <div style="margin-top: 20px; text-align: center;">
      <button id="listenBtn">🔊 Listen</button>
      <button id="resetBtn">🔁 Reset</button>
    </div>
  ...
  <a href="https://kanchikamakshi.org/" target="_blank" style="text-decoration: none;">
    ...
    <p> Accommodation is provided to devotees visiting Shrimatam, Kanchipuram at the Yatri Nivas on Sri Kamakshi Amman Sannadhi Street (located very close to the Main Entrance of Sri Kamakshi Amman temple).</p>
    <div style="margin-top: 20px; text-align: center;">
      <button id="listenBtn">🔊 Listen</button>
      <button id="resetBtn">🔁 Reset</button>
    </div>
    ...
    dress: ` 
      ...
      <p> Avoid photography inside the temple.</p>
      <p> Facilities Parking, restrooms, and drinking water facilities are available.</p>
      <p> Keep your noise levels to the minimum to maintain sanctity within the temple premises.</p>
      <p> Early morning is the best time to be here if you wish to avoid the crowds.</p>
      <div style="margin-top: 20px; text-align: center;">
      <button id="listenBtn">🔊 Listen</button>
      <button id="resetBtn">🔁 Reset</button>
    </div>
    ...
    <p style="text-align: center;">📍Kanchipuram,Tamil Nadu</p>
    <div style="text-align: center; margin-top: 15px;">
    <button onclick="window.open('https://www.google.com/maps/d/u/0/edit?mid=17hF8fMs6f_UjY7n9PDGZVdXXBDquHGM&usp=sharing', '_blank')" style="background-color: #4e3ec8; color: white; border: none; padding: 10px 20px; border-radius: 6px; cursor: pointer; font-size: 16px;">🗺️ View Location on Map </button>
  </div>

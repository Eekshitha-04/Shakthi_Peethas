const contentData = {
    ...
    significance: `
        <h3>Significance</h3>
        <p> It is one of the eighteen Maha Sakthi Peethas considered the most significant pilgrimage destinations in Shaktism.</p>
        <p> Temple holds significant religious and cultural importance for devotees, particularly followers of Lord Shiva.</p>
        <p> Serving as a symbol of faith, tradition, and spirituality.</p>
        <p> Kukkuteswara Temple is a Hindu temple in Pitapuram town of Kakinada district, Andhra Pradesh, India.
        <p> The temple is dedicated to lord shiva. </p>
        <p> Lord Shiva seld manifested here in the form of Cock's Head which is later covered with the present Linga form.</p>
        <p> The temple is also famous for its single-stone Nandi and a self-originated Shiva Linga.</p>
        <div style="margin-top: 20px; text-align: center;">
      <button id="listenBtn">🔊 Listen</button>
      <button id="resetBtn">🔁 Reset</button>
    </div>
    ...
    festivals: `
        ...
        <p> Maha Shivaratri.</p>
        <p> Karthika Masam.</p>
        <p> Devi Navarathri’s during Dussehra are the main festivals celebrated at this temple.</p>
        <p> The temple also celebrates Maghabahula Ekadasi for Kukkuteswara, Suddha Ekadasi for Kunti Madhava worship, Kumaraswamy during Palguna Masa.</p>
        <div style="margin-top: 20px; text-align: center;">
      <button id="listenBtn">🔊 Listen</button>
      <button id="resetBtn">🔁 Reset</button>
    </div>
    ...
    howtoreach: `
      <h3>How to Reach</h3>
      <p>📍 Location: Pithapuram,Andhra Pradesh<br>✈️ Nearest Airports: Rajahmundry Airport (57 KM) <br>🚉 Railway Station: Kakinada Town Railway Station North Terminal (16 KM) <br>🛣️ Road ways: Samarlakota - 12 KM</p>
      <div style="margin-top: 20px; text-align: center;">
      <button id="listenBtn">🔊 Listen</button>
      <button id="resetBtn">🔁 Reset</button>
    </div>
    ...
    timings: `
      ...
      <p>🕘 Morning: 5:00 AM - 12:30 PM<br>🕓 Evening: 4:30 AM - 8:30 PM</p>
      <div style="margin-top: 20px; text-align: center;">
      <button id="listenBtn">🔊 Listen</button>
      <button id="resetBtn">🔁 Reset</button>
    </div>
    ...
    foodaccom: `
      ...
      <p> Located 1.2 km from the Pithapuram bus stand, Kukkuteswara Devasthanam offers three and four-bedded AC rooms as well as AC dormitory accommodation. Meals are available here.</p>
      <div style="margin-top: 20px; text-align: center;">
      <button id="listenBtn">🔊 Listen</button>
      <button id="resetBtn">🔁 Reset</button>
    </div>
    ...
    <p style="text-align: center;">📍Pithapuram,Andhra Pradesh</p>
    <div style="text-align: center; margin-top: 15px;">
    <button onclick="window.open('https://www.google.com/maps/d/u/0/edit?mid=1uGsiKudPDDVyckejZIC-tp6gMjHW7l0&usp=sharing', '_blank')" style="background-color: #4e3ec8; color: white; border: none; padding: 10px 20px; border-radius: 6px; cursor: pointer; font-size: 16px;">🗺️ View Location on Map </button>
  </div>

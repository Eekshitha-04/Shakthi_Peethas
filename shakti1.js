  ...
  const contentData = {
    ...
    significance: `
      ...
      <p> The deity was being worshipped here more than 2500 years ago even before one of the first Kings, Prince Vijay, landed in Sri Lanka in 300 BC.</p>
      <P>  It was one of the wealthiest temples in the South and had a large structure on the rock. </P>
      <p> Archaeological information states that there were three temples on the hilltop. </p>
      <p> The journey for pilgrims in the town begins at the opening of Konesar Road and follows a path through courtyard shrines of the compound to the deities Bhadrakali, Ganesha, Vishnu Thirumal, Surya, Raavana, Ambal-Shakti, Murukan and Shiva who presides at the promontory's height.</p> 
      <p> The annual Koneswaram Temple Ther Thiruvilah festival involves the Bhadrakali temple of Trincomalee, the Pavanasam Theertham at the preserved Papanasuchunai holy well and the proximal Back Bay Sea (Theertham Karatkarai) surrounding Konesar Malai.</p>
      <p> The tallest Gopuram with the Indian Ocean in its backdrop had the statue of the main deity. The temple was a massive structure with around 1000 pillars and small mandaps.</p>
      <div style="margin-top: 20px; text-align: center;">
      <button id="listenBtn">🔊 Listen</button>
      <button id="resetBtn">🔁 Reset</button>
    </div>
    ...
    festivals: `
      ...
      <p> The Ther Chariot Festival (Ratha yatra) lasts for twenty two days in April.</p>
      <p> The Tamil New Year. Navaratri lasts for nine days and is dedicated to various aspects of the presiding goddess.</p>
      <p> Sivarathri is dedicated to Siva. Devotees visit the temple to attend the daily pujas and make their offerings.</p>
      <p> The water-cutting Theertham Thiruvilah festival (holy bath) takes place annually in the centuries-old Papanasachunai holy well (Papanasam Theertham) on Swami Rock during the Ther festival period. </p>
      <p> The Koneswaram Poongavanam Festival the Temple Garden Festival is held during this twenty-two-day festival period.</p>
      <p> An annual three-day procession follows Maha Shivaratri Day.</p>
      <div style="margin-top: 20px; text-align: center;">
      <button id="listenBtn">🔊 Listen</button>
      <button id="resetBtn">🔁 Reset</button>
    </div>
    ...
    howtoreach: `
      <h3>How to Reach</h3>
      <p>📍 Location: Trincomalee, Sri Lanka<br>✈️ Nearest Airports: Bandaranaike (240 KM), Sigiriya (101 KM)<br>🚉 Railway Station: Trincomalee (3.1 KM)</p>
      <div style="margin-top: 20px; text-align: center;">
      <button id="listenBtn">🔊 Listen</button>
      <button id="resetBtn">🔁 Reset</button>
    </div>
    ...
    timings: `
      ...
      <p>🕘 Morning:6:00 AM - 1:00 PM<br>🕓 Evening:4:00 PM - 6:45 PM</p>
      <div style="margin-top: 20px; text-align: center;">
      <button id="listenBtn">🔊 Listen</button>
      <button id="resetBtn">🔁 Reset</button>
    </div>
    ...
    foodaccom: `
      ...
      <p> Revenue from the temple provides services and food to local residents.</p>
      <p> Amaranthé Bay Resort & Spa ,(4.5 Rating) 7.4 KM</p>
      <div style="margin-top: 20px; text-align: center;">
      <button id="listenBtn">🔊 Listen</button>
      <button id="resetBtn">🔁 Reset</button>
    </div>
    ...
    dress: ` 
      ...
      <p> Dress modestly and respect the temple's rules and regulations.</p>
      <p>  Remove your shoes before entering the temple premises.</p>  
      <p>  Photography is not allowed inside the temple.</p>  
      <p>  Carry a water bottle and wear comfortable shoes as the temple involves climbing stairs.</p> 
      <p>  Visit the temple during the early morning or late afternoon to avoid the crowd and heat.</p>
      <div style="margin-top: 20px; text-align: center;">
      <button id="listenBtn">🔊 Listen</button>
      <button id="resetBtn">🔁 Reset</button>
    </div>
    ...
    <p style="text-align: center;">📍Trincoli, Srilanka</p>
    <div style="text-align: center; margin-top: 15px;">
    <button onclick="window.open('https://www.google.com/maps/d/u/0/edit?mid=1ZFue0n1DrF_vyhw41IUhggsSv1P_Kzo&usp=sharing', '_blank')" style="background-color: #4e3ec8; color: white; border: none; padding: 10px 20px; border-radius: 6px; cursor: pointer; font-size: 16px;">🗺️ View Location on Map </button>
  </div>

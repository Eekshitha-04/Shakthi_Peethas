const contentData = {
    history: `
        <h3>History</h3>
        <p>The roots of the Vishalakshi Temple trace back to the tragic tale of Sati, the daughter of Prajapati Daksha, who defied her father’s wishes to marry Lord Shiva. </p>
                <p>The temple is believed to be a Shakti Pitha, a holy site where the earrings or eyes of Mata Sati fell. Sati’s poignant story involves her self-immolation during a Yagya organized by her father, Daksha, after he intentionally excluded her and Lord Shiva. </p>
                <p>The temple was established where a fragment of Sati’s body touched the ground.</p>
        <div align="center">
    ...
    significance: `
        <h3>Significance</h3>
         <p> Devotees take bath in holy River Ganges and offer prayers to the Goddess.</p>
                    <p> Varanasi, a city that represents Shastanga (six-fold) yoga, houses six temple locations, including the holy River Ganga, the Vishwanath Temple, the Vishalakshi Temple, the Kala Bhairava Temple, the Dhudiraj Temple (dedicated to Lord Ganesha), and the Dandapani Temple (dedicated to Lord Shiva). </p>
                    <p> The Vishalakshi Temple is a focal point of spiritual energy, attracting devotees seeking the blessings of Goddess Vishalakshi.</p>
                    <p> Devotees visit this temple to seek fulfillment of the following:-</p>
                    <p> Salvation</p>
                    <p> Wealth</p>
                    <p> Relief from diseases</p>
                   <p>  Purchase of vehicles</p>
                    <p> Gain Knowledge</p>
                    <p> Dedicated to Goddess Parvati, also known as Vishalakshi Maa or Vishalakshi Gauri, this revered temple holds profound significance in Hinduism.</p>
                    <div style="margin-top: 20px; text-align: center;">
      <button id="listenBtn">🔊 Listen</button>
      <button id="resetBtn">🔁 Reset</button>
    </div>
    ...
    festivals: `
        <h3>Festivals</h3>
         <p> Devotees flock to the temple in the evening of the fifth day of Navatri. </p>
                    <p> The yearly temple festival of Vishalakshi Temple is celebrated on Kajali Tij (Black Third), the third lunar day (tij) of the waning fortnight in Bhadrapada, the last month of the Indian rainy season.</p>
                    <div style="margin-top: 20px; text-align: center;">
      <button id="listenBtn">🔊 Listen</button>
      <button id="resetBtn">🔁 Reset</button>
    </div>
    ...
    howtoreach: `
      <h3>How to Reach</h3>
      <p>📍 Location: Varanasi,Uttar Pradesh<br>✈️ Nearest Airports: Lal Bahadur Shastri International Airport (26 KM)<br>🚉 Railway Station:  Varanasi junction (4.6KM) <br>🛣️ Road ways: Ramnagar (8.7 KM)</p>
      <div style="margin-top: 20px; text-align: center;">
      <button id="listenBtn">🔊 Listen</button>
      <button id="resetBtn">🔁 Reset</button>
    </div>
    ...
    timings: `
      ...
      <p>🕘 All days:  6:00AM - 10:00PM<br>🕓 Evening: Saturday & Tuesday:  6:00 AM - 9:45 PM</p>
                    <div style="margin-top: 20px; text-align: center;">
      <button id="listenBtn">🔊 Listen</button>
      <button id="resetBtn">🔁 Reset</button>
    </div>
    ...
    <p><b>Prasadam:</b>prasadam typically includes items such as kheer (rice pudding), puri (fried bread), sabzi (vegetable curry), sweets like ladoo or peda, and sometimes fruits. These prasadams are offered to the goddess Vishalakshi during puja rituals and then distributed to devotees as blessings.</p>
                <P> Varanasi being an important tourist destination for both pilgrims as well as other tourists features numerous economic hotels as well as luxury hotels and guest houses.</P>
                    <P> Hotel such as Taj Ganges, Hotel Surabhi International, Hotel Varanasi Ashok, Hotel De Paris, and Hotel M M Continental are all situated within a short distance from Kashi Vishwanath Temple.</P>
                    <P> Regular offerings include flowers, Ganga jal and clothes.</P>
                    <div style="margin-top: 20px; text-align: center;">
      <button id="listenBtn">🔊 Listen</button>
      <button id="resetBtn">🔁 Reset</button>
    </div>
    ...
    <p style="text-align: center;">📍Varanasi,Uttar Pradesh</p>
    <div style="text-align: center; margin-top: 15px;">
    <button onclick="window.open('https://www.google.com/maps/d/u/0/edit?mid=1myCOGfEZisgfkpqgeftvDcrKODBwq5c&usp=sharing', '_blank')" style="background-color: #4e3ec8; color: white; border: none; padding: 10px 20px; border-radius: 6px; cursor: pointer; font-size: 16px;">🗺️ View Location on Map </button>
  </div>

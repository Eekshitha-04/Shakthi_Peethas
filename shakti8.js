const contentData = {
    ...
    significance: `
        <h3>Significance</h3>
        <p> It is believed that the goddess has magical powers.</p>
        <p> The temple gains its importance in the Indian culture.</p>
        <p> The temple is a prime spot of worship for the Aagri and Koli people. </p>
        <p> The Ekvira Devi Temple holds great religious and cultural significance for the people of Maharashtra and beyond.</p>
        <p> Devotees believe that the Goddess Ekvira can grant wishes and blessings, and visiting the temple is considered a means of seeking her divine intervention.</p>
        <p> Ekvira Devi temple is located in Lonavala, Western Maharashtra, India, close to the Karla Caves.</p> 
        <p> It is a prominent religious temple, particularly for the Koli community in Maharashtra.</p>
        <p> To obtain the blessings of Ekvira Devi, who is revered as a goddess of protection and wish fulfilment, devotees travel to the temple.</p>
        <p> The temple, which is housed in a structure resembling a cave, is a significant place with extraordinary religious importance.</p>
        <p> It is regarded to be a form of the goddess Renuka.She isthmus kuladevi of the koli people every year kolis pay respect to Ekavira and celebrate the festival in Karla Caves.</p>
        <p> The Ekvira Temple is a revered place for the local fishermen community. The deity that occupies pride of place here is the Aai Ekvira, the tribal Goddess worshiped by the Agri community.</p> 
        <p> It is believed that the temple was built by the Pandavas when they visited this part during their 14-year long exile.</p>
        <p> The temple is on a hill. One needs to ascend around 500 steps to reach the temple. It is surrounded by the Karla caves, which are now protected by the Archeological department.</p>
        <p>  While the main deity is Ekvira, she is accompanied by a murti of Jogesvari Devi. Ekvira is a Hindu goddess, regarded to be a form of the goddess Renuka. She is the kuladevi of the Koli people.</p>
        <div style="margin-top: 20px; text-align: center;">
      <button id="listenBtn">🔊 Listen</button>
      <button id="resetBtn">🔁 Reset</button>
    </div>
    ...
    festivals: `
        <h3>Festivals</h3>
        <p> The devotees throng the temple on all occasions of Navaratri and Chaitra Navratra to worship and celebrate.</p>
        <p> Chytra Palkhi Festival (March, April).</p>
        <p> Gudi Padwa,Mahashivratri,Akshaya Tritiya,Gauri Pujan, Durga Ashtami, and Palkhi Processions.</p>
        <div style="margin-top: 20px; text-align: center;">
      <button id="listenBtn">🔊 Listen</button>
      <button id="resetBtn">🔁 Reset</button>
    </div>
    ...
    howtoreach: `
      <h3>How to Reach</h3>
      <p>📍 Location: Mahur,Maharashtra<br>✈️ Nearest Airports: Pune International Airport (62 KM)<br>🚉 Railway Station: Pune railway station (59 KM) <br>🛣️ Road ways: Aamby Valley City (35 KM)</p>
      <div style="margin-top: 20px; text-align: center;">
      <button id="listenBtn">🔊 Listen</button>
      <button id="resetBtn">🔁 Reset</button>
    </div>
    ...
    <p style="text-align: center;">📍Mahur,Maharashtra</p>
    <div style="text-align: center; margin-top: 15px;">
    <button onclick="window.open('https://www.google.com/maps/d/u/0/edit?mid=1F0NNeuMGjt4Y34ppJK-5ogMLJ8IgiHc&usp=sharing', '_blank')" style="background-color: #4e3ec8; color: white; border: none; padding: 10px 20px; border-radius: 6px; cursor: pointer; font-size: 16px;">🗺️ View Location on Map </button>
  </div>

const contentData = {
    history: `
        <h3>History</h3>
        <p>The temple is also believed as the center of the earth or eastern hemisphere. There is a belief that after taking birth for killing Asur Bhandasur, Devi sat here taking “Kanya Swarup.” The idol is “Swayambhu,” which signifies it has appeared and not created. She is believed to have three Swarups in the temple. These include Sthula, Sukshama, and Shunya.</p>
    ...
    significance: `
        <h3>Significance</h3>
        <p> This temple has a rich historical and mythological significance. History: </p>
        <p> The history of the Maa Biraja Temple dates back over 1,000 years.</p>
        <p> Temple stands as a testament to the rich cultural and religious heritage of the region. This ancient temple is dedicated to Goddess Biraja, a form of Goddess Durga, and has a history that dates back centuries.</p>
        <p> Name of shakti : Maa Biraja(Girija Devi).</p>
        <p>	The Biraja Temple, or Birija Kshetra (Birajā Ksetra), is a historic Hindu temple located in Jajpur,Odisha, India. </p>
        <p> The temple covers a large area, and has several shrines to Shiva and other deities. </p>
        <p> According to the Skanda Purana it cleanses pilgrims, and it is called the Viraja or the Biraja kshetra.</p>  
        <div style="margin-top: 20px; text-align: center;">
      <button id="listenBtn">🔊 Listen</button>
      <button id="resetBtn">🔁 Reset</button>
    </div>  
    ...
    festivals: `
        <h3>Festivals</h3>
        <p> The primary ritual in the temple is Sharadiya Durga Puja, which begins on the night of Krishna Paksha Ashtami. This falls before Mahalaya, and ends on Ashwin Shukla Paksha Navami. </p>
        <p>  The puja, known as Shodasha Dinatatmika Puja, lasts for 16 days. The ratha (chariot festival) is known as Simhadhwaja, and its flag bears a lion.</p> 
        <p>  During the lunar transition from Shukla Ashtami to Shukla Navami an animal sacrifice, Bali Daanam, is performed. Navratri is celebrated as Aparajita Puja.</p>
        <p> Other festivals include Nakshatra, Shravana, Prathamastami, Pana Sankranti, Raja Parva and Navanna. Devi is worshiped daily in accordance with Tantra and Agama traditions as Mahishasuramardini by the Brahmins of Jajpur.</p>
        <div style="margin-top: 20px; text-align: center;">
      <button id="listenBtn">🔊 Listen</button>
      <button id="resetBtn">🔁 Reset</button>
    </div>
    ...
    howtoreach: `
      <h3>How to Reach</h3>
      <p>📍 Location: Jajpur,Odisha<br>✈️ Nearest Airports: Biju Patnaik International Airport (104 KM) <br>🚉 Railway Station: Cuttack Railway Station (76 KM) <br>🛣️ Road ways: Bhadrak (36 KM)</p>
      <div style="margin-top: 20px; text-align: center;">
      <button id="listenBtn">🔊 Listen</button>
      <button id="resetBtn">🔁 Reset</button>
    </div>
    ...
    timings: `
      ...
      <p>🕘 Morning: 6:00AM - 1:00 PM<br>🕓 Evening: 3:00 PM - 10:00 PM</p>
      <div style="margin-top: 20px; text-align: center;">
      <button id="listenBtn">🔊 Listen</button>
      <button id="resetBtn">🔁 Reset</button>
    </div>
    ...
    dress: ` 
      ...
      <p> Do respect ancient customs and co-piligrims while at temple.
      <p> Smoking and drinking is prohibited in this temple.
      <p> Chewing betel leaves, tobacco, gutka and spitting inside temple is strictly prohibited.
      <p> For men the dress code is Shirt & Trouser, Dhoti or Pyjamas with upper cloth. 
      <p> For women the preferred dress code is saree or half-saree with blouse or chudidhar.</p>
      <div style="margin-top: 20px; text-align: center;">
      <button id="listenBtn">🔊 Listen</button>
      <button id="resetBtn">🔁 Reset</button>
    </div>
    ...
    <p style="text-align: center;">📍Jajpur,Odisha</p>
    <div style="text-align: center; margin-top: 15px;">
    <button onclick="window.open('https://www.google.com/maps/d/u/0/edit?mid=1UNZYrCXntuubsrGfGQOCbDX1ucjw1_M&usp=sharing', '_blank')" style="background-color: #4e3ec8; color: white; border: none; padding: 10px 20px; border-radius: 6px; cursor: pointer; font-size: 16px;">🗺️ View Location on Map </button>
  </div>

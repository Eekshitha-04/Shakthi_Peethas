const contentData = {
    history: `
        ...
        <p>The beautiful temple has endured the perils of time and still emerged as a testament to the faith of Shiva devotees. You won’t get enough of the artistic excellence bouncing off its walls and the colossal idol of Lord Mahakal whose sight is a blessing in itself.</p>
        <p>Lakhs of Shiva Bhakts attend the famous Bhasma Aarti at the break of every dawn. From tales of miracles and unanswered mysteries to the unshakable faith of many, Mahakaleswar’s Shikhar is witness to a lot of divine happenings.</p>
    ...
    significance: `
        <h3>Significance</h3>
        <p> It is believed that a visit to this temple can help one overcome the fear of death and the constraints of time.</p>
        <p> Spiritual Ujjain: Ujjain itself holds immense spiritual significance.</p>
        <p> The idol of Mahakaleshwar is known to be dakshinamurti, facing the South.</p>
        <p> Lord Mahakaleshwar resides in the sacred city of Ujjain, India and is the third Jyotirlinga.</p>
        <p> Prajapati Brahma himself established the first temple at the site. The coins recovered at Ujjain have the mark of Lord Shiva on them.</p>
        <p> According to several poetic texts, in the Paramara period, invaders destroyed the temple. Later, Udayaditya and Naravarman rebuilt it.</p>    
        <div style="margin-top: 20px; text-align: center;">
      <button id="listenBtn">🔊 Listen</button>
      <button id="resetBtn">🔁 Reset</button>
    </div>
    ...
    festivals: `
        <h3>Festivals</h3>
        <p> On the day of Mahashivaratri, a huge fair is held near the temple, Thousands of pilgrims flock to the fair grounds near the Mahakaleshwar temple and do their worship throughout the night.</p>
        <div style="margin-top: 20px; text-align: center;">
      <button id="listenBtn">🔊 Listen</button>
      <button id="resetBtn">🔁 Reset</button>
    </div>
    ...
    howtoreach: `
      <h3>How to Reach</h3>
      <p>📍 Location: Ujjain,Madhya Pradesh<br>✈️ Nearest Airports: Indore Airport (58 KM)<br>🚉 Railway Station:  Ujjain railway station (1.3 KM)<br>🛣️ Road ways: Jantar mantar(2.6 KM)</p>
      <div style="margin-top: 20px; text-align: center;">
      <button id="listenBtn">🔊 Listen</button>
      <button id="resetBtn">🔁 Reset</button>
    </div>
  ...
  <a href="https://shrimahakaleshwar.com/" target="_blank" style="text-decoration: none;">
    ...
    dress: ` 
      ...
      <p> Pilgrims should also be mindful of the religious practices and customs observed at the Mahakaleshwar Temple.</p>
      <p> Photography is generally not allowed inside the sanctum sanctorum.</p>
      <p> And visitors should refrain from any behaviour that may disrupt the peaceful atmosphere or offend the religious sentiments of others.</p>
      <p> Devotees are not allowed to carry cameras, purse, bags etc. inside the temple.</p>  
      <div style="margin-top: 20px; text-align: center;">
      <button id="listenBtn">🔊 Listen</button>
      <button id="resetBtn">🔁 Reset</button>
    </div>    
    ...
    <p style="text-align: center;">📍Ujjain,Madhya Pradesh</p>
    <div style="text-align: center; margin-top: 15px;">
    <button onclick="window.open('https://www.google.com/maps/d/u/0/edit?mid=1xGsmNX1WKUrfxKgYYmPtzaFM1lR4D7Y&usp=sharing', '_blank')" style="background-color: #4e3ec8; color: white; border: none; padding: 10px 20px; border-radius: 6px; cursor: pointer; font-size: 16px;">🗺️ View Location on Map </button>
  </div>

const contentData = {
    history: `
        ...
        <p>Here the Goddess Bhramaramba Devi is worshiped in Brahmani Shakti form. The Goddess idol in the temple has eight arms, and she wears a silk sari. You can also see an idol of Lopamudra, who is the wife of saint Agastya at the temple’s garbha griha. Sri Yantra is also there is garbha griha’s front.</p>
        ...
        <p>As Brahma signifies bee, you can also hear the bee’s sound in the main temple’s backside.</p>
        <p>As per ancient scriptures, once Lord Shiva and Parvati’s sons – Ganesha and Kartikeya went into an argument that who among them is greatest and sought their parent’s opinion.</p>
        ...
        <p>But Ganesha rides his mouse and started making Pradakshina (Circumambulation) of Devi Parvati and Lord Shiva. He said that touring his mother and father is equivalent to taking rounds of three worlds. Lord Shiva and Parvati, pleased with Ganesha’s words, declared him the winner.</p>
    ...
    significance: `
        <h3>Significance</h3>
        <P> The temple’s place is very divine, on the top of the Nallamala hills beside the river Krishna.</P>
        <P> It worships the deity Lord Mallikarjuna Swamy, who is considered one of the 12 Jyotirlingas of Lord Shiva. The vast compound area of the temple has divisions into two parts. One is for Lord Mallikarjuna, and another is for Goddess Bhramaramba.</P>
        <P> The temple holds the Jyotirlinga in immense holiness as worshippers consider it Swayambhu, meaning self-manifested. </P>
        <P> Lord Rama is believed to have consecrated the Sahasralinga within the temple. The Linga comprises 25 facets, symbolizing 40 Lingas. Additionally, it is widely believed that the Pandavas installed the Pancha Pandava Lingas in the temple, each bearing Sadyojatha, Aghora, Vamadeva, Tatpurusha, and Eesana.</P>        
    ...
    festivals: `
        <h3>Festivals</h3>
        <p> The <b>Dasara Mahotsavam</b> is one of the most important festivals celebrated. It is a time for devotees to come together and celebrate the victory of good over evil.</p>
        <p> <b>Kumbhothasavam</b> is the most significant festival various offerings are made to Goddess Bhramaramba Devi. This festival celebrates on the <b>first Tuesday or Friday</b> (which ever first comes) after full moon day of Chaitram, the beginning month of Indian Calendar.</p>
        <div style="margin-top: 20px; text-align: center;">
      <button id="listenBtn">🔊 Listen</button>
      <button id="resetBtn">🔁 Reset</button>
    </div>
    ...
    howtoreach: `
      <h3>How to Reach</h3>
      <p>📍 Location: Srisailam,Andhra Pradesh<br>✈️ Nearest Airports: Rajiv Gandhi International Airport (196 KM), Kurnool Airport (182 KM) <br>🚉 Railway Station:  Markapur- Railway station (84 KM) <br>🛣️ Road ways: Srisailam Project Dam (14 KM)</p>
      <div style="margin-top: 20px; text-align: center;">
      <button id="listenBtn">🔊 Listen</button>
      <button id="resetBtn">🔁 Reset</button>
    </div>
    ...
    timings: `
      ...
      <p>🕘 Morning: 6:00 AM - 3:30 PM<br>🕓 Evening: 6:00 PM - 10:00 PM</p>
      <div style="margin-top: 20px; text-align: center;">
      <button id="listenBtn">🔊 Listen</button>
      <button id="resetBtn">🔁 Reset</button>
    </div>
  ...
  <a href="https://www.srisailadevasthanam.org/" target="_blank" style="text-decoration: none;">
    ...
    foodaccom: `
      ...
      <p> Accommodation facilities are also good for devotees. Pilgrim Accommodation Complex: The Pilgrim Accommodation Complex near the temple premises provides affordable accommodation for devotees. These complexes consist of rooms and dormitories withshared facilities.</p>
    ...
    dress: ` 
      ...
      <p> No western clothes are allowed inside the temple premises.</p> 
      <p> Girls must cover their whole body by draping a Saree or by sporting any ethnic wear with a Duppatta for sure. Women are strictly prohibited inside the temple if they don't sport a duppatta or a saree. </p>
      <p>	And when it comes to Men, the same rule applies. No western clothes and no shorts allowed inside the temple. They must be traditionally dressed up in Kurta Pyjamas or Veshti or Shirt and Trouser to enter inside the temple for Darshan. These rules are to maintain the cultural decorum of the temple.</p>
      <p> Smart phones, or any kind of gadgets are strictly prohibited to take inside the main temple. They can be stored safely near the temple premises. Safety lockers are available for gadgets and luggage.</p>
      <div style="margin-top: 20px; text-align: center;">
      <button id="listenBtn">🔊 Listen</button>
      <button id="resetBtn">🔁 Reset</button>
    </div>
    ...
    <p style="text-align: center;">📍Srisailam,Andhra Pradesh</p>
    <div style="text-align: center; margin-top: 15px;">
    <button onclick="window.open('https://www.google.com/maps/d/u/0/edit?mid=1_WCmrqmj6IOqE6j3KYgQCByBq44k40c&usp=sharing', '_blank')" style="background-color: #4e3ec8; color: white; border: none; padding: 10px 20px; border-radius: 6px; cursor: pointer; font-size: 16px;">🗺️ View Location on Map </button>
  </div>

const contentData = {
    ...
    significance: `
        <h3>Significance</h3>
        <P> It is one of the oldest and most revered centres of Tantric practices, dedicated to the goddess Kamakhya. </P>
                <P> The presiding deity, Devi Kamakhya, represents the power of femininity and fertility.</P>
                <P> The temple holds great importance for devotees seeking blessings for marital harmony, progeny, and overall well-being.</P>
                <div style="margin-top: 20px; text-align: center;">
      <button id="listenBtn">🔊 Listen</button>
      <button id="resetBtn">🔁 Reset</button>
    </div>
    ...
    festivals: `
        <h3>Festivals</h3>
       <p> Ambubachi Mela is one of the biggest congregations of eastern India. It is the most important festival of the Kamakhya temple and is celebrated in the month of June every year.</p>
                <p> Durga Puja.</p>
                <p> Manasha Puja.</p>
                <div style="margin-top: 20px; text-align: center;">
      <button id="listenBtn">🔊 Listen</button>
    ...
    howtoreach: `
      <h3>How to Reach</h3>
      <p>📍 Location: Guwahati,Assam<br>✈️ Nearest Airports: Lokpriya Gopinath Bordoloi International Airport (20 KM) <br>🚉 Railway Station:  Guwahati Railway Station (8.1 KM) <br>🛣️ Road ways: IIT Guwahati (19 KM)</p>
      <div style="margin-top: 20px; text-align: center;">
      <button id="listenBtn">🔊 Listen</button>
      <button id="resetBtn">🔁 Reset</button>
    </div>
    ...
    timings: `
      ...
      <p>🕘 Morning: 08:00 AM - 01:00PM<br>🕓 Evening: 02:30PM - 05:30PM</p>
      <div style="margin-top: 20px; text-align: center;">
      <button id="listenBtn">🔊 Listen</button>
      <button id="resetBtn">🔁 Reset</button>
    </div>
  ...
  <a href="https://www.maakamakhya.org/" target="_blank" style="text-decoration: none;">
    ...
    <p><b>Prasadam:</b>prasadam typically includes items such as kheer (rice pudding), sweets made from coconut and jaggery, various types of ladoo (sweet balls), and sometimes offerings of fruits and betel leaves. Additionally, special items like pitha (Assamese rice cakes) may also be served as prasadam. These prasadams are offered to the goddess Kamakhya during puja rituals and then distributed to devotees as blessings.</p>
            <P> The Assam Development Corporation has its own tourist home called as Lalita Kanta Yatri Niwas.
                <P> It offers excellent lodging as well as a food facility. While the cost of the rooms is moderate, all kinds of modern amenities are present for the visitors to use as well.</P>
                <P> Moreover, the presence of many luxuries and budget hotels is also present for travellers at the Nilachal Hills.</P>
                <P> From lodges to guest homes and a temple run guest house, visitors have lots of choices. One can also decide to put up at Guwahati and travel to the temple by availing public transportation like buses, auto-rickshaws and taxis.</P>
                <div style="margin-top: 20px; text-align: center;">
      <button id="listenBtn">🔊 Listen</button>
      <button id="resetBtn">🔁 Reset</button>
    </div>
    ...
    dress: ` 
      ...
      <p> Cameras are allowed. </p>
                <p> Photography is not allowed inside the inner shrine</p>
    ...
    <button onclick="window.open('https://www.google.com/maps/d/u/0/edit?mid=1noVYQVj2xsc9vp2HB2P-44aNGN91TF4&usp=sharing', '_blank')" style="background-color: #4e3ec8; color: white; border: none; padding: 10px 20px; border-radius: 6px; cursor: pointer; font-size: 16px;">🗺️ View Location on Map </button>
  </div>
